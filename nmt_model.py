...
"""
Bharath Kumar Dasa
Code line no 77 to 91
Code line no 167 to 179
include import pad_packed_sequence, pack_padded_sequence
Code line no 247 to 257
Code line no 312 to 317
Code line no 351 to 358
"""
import sys
...
class NMT(nn.Module):
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        alpha_t = alpha_t.unsqueeze(dim=2)                                  
        a_t = torch.bmm(enc_hiddens.permute(0,2,1), alpha_t)                
